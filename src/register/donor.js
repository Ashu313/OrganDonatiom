  ...
  return (
    ...
    >
      ...
      <Stack spacing={2} style={{background:"linear-gradient(91deg, #46052D 0%, #46052D 0.01%, #500732 15.52%, #5E0933 32.71%, #610834 47.81%, #6A0B37 63.44%, #991747 76.98%, #B32346 94.17%)"}}>
        <Item  style={{background:"linear-gradient(91deg, #46052D 0%, #46052D 0.01%, #500732 15.52%, #5E0933 32.71%, #610834 47.81%, #6A0B37 63.44%, #991747 76.98%, #B32346 94.17%)",color:"white",height:'100px',fontSize:"30px",textAlign:"left",padding:"1rem"}} >Register As Organisation</Item>
